...
Det er bevidst ikke en omgåelse af betalingsmure eller digitale læsere. Magasinet MUSEUM og PROSAbladet har direkte offentlige PDF-filer i deres arkiver; Periskop går via én officiel downloadside, og On-Curating og e-flux eksponerer PDF'en fra den officielle nummerside. Hver aktiv kilde har en specifik tilladt PDF-adresse, så eksempelvis en jobannonce på et magasin-sites domæne aldrig kan blive hentet som et magasin. Ud & Se bruger iPaper-læserens egen offentlige **Download PDF**-handling, som udsteder en frisk, tidsbegrænset filadresse; henteren gemmer stadig det stabile nummerlink, så den aldrig henter samme nummer igen. Kun den aktuelle Ud & Se-adresse er konfigureret, så en test ikke importerer gamle arkivudgaver. J26 kræver e-mail for at frigive sin PDF, og KALTBLUTs nyeste nummer eksponerer ingen PDF; de to er derfor deaktiveret.
