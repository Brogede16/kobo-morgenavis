...
Det er bevidst ikke en omgåelse af betalingsmure eller digitale læsere. Magasinet MUSEUM og PROSAbladet har direkte offentlige PDF-filer i deres arkiver; Periskop går via én officiel downloadside, og On-Curating og e-flux eksponerer PDF'en fra den officielle nummerside. Hver aktiv kilde har en specifik tilladt PDF-adresse, så eksempelvis en jobannonce på et magasin-sites domæne aldrig kan blive hentet som et magasin. J26 kræver e-mail for at frigive sin PDF, KALTBLUTs nyeste nummer eksponerer ingen PDF, og Ud & Se's iPaper-læser eksponerer ikke en stabil PDF-adresse. De tre er derfor deaktiveret, indtil de har en stabil offentlig nummer-PDF. Du kan når som helst trykke **Scan og hent magasiner nu** for at få de nuværende offentlige filer uden at vente på natkørslen.
