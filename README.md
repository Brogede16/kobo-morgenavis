...
Tallene står i `sources.yaml` og er dem, der styrer forbruget. Udgaven samler op til 360 kandidater og triagerer dem gratis lokalt før AI-kaldet. 55 pladser er reserveret til web- og nyhedsradar-resultater, så RSS-mængden ikke skubber dem ud. Websøgeren får kun 200 tegn fra hvert radar-preview; de længere previews er forbeholdt den billigere redaktør. Redaktøren ser op til 75 kildebalancerede resuméer á 400 tegn; det passer reelt under promptens hårde loft på 90.000 tegn. Der er normalt to OpenAI-kald pr. udgave: én websøgning med højst 2.200 outputtokens og selve udvælgelsen med højst 5.200. Begge får ét genforsøg ved en midlertidig fejl. Den faste redaktionelle profil ligger først i prompten, så udbyderens automatiske promptcache kan genbruges. Artiklerne omskrives ikke af AI. Den komplette redaktionelle historik bliver i Git, mens kun otte relevante positive og negative eksempler samt klikfeedback fra de seneste 120 dage indgår i en kørsel. Sæt et spend alert på OpenAI-kontoen som ekstra sikkerhedsnet.

En kørsel har et samlet tidsloft på 30 minutter, og dens webcache er begrænset til 25 MB. En fastlåst kørselsmarkering betragtes som forældet efter 45 minutter. Efter en vellykket Drive-upload fjernes lokale udgaver, der er ældre end to dage. Fejl i nyhedsradaren eller websøgningen degraderer til de øvrige kilder og vises i kontrolpanelet; de vælter ikke automatisk hele udgaven.
