...
Det er bevidst ikke en omgåelse af betalingsmure eller digitale læsere. Magasinet MUSEUM og PROSAbladet har direkte offentlige PDF-filer i deres arkiver; Periskop går via én officiel downloadside, og On-Curating og e-flux eksponerer PDF'en fra den officielle nummerside. J26 kræver e-mail for at frigive sin PDF, og KALTBLUTs nyeste nummer eksponerer ingen PDF; begge registreres derfor blot som ikke-tilgængelige. Ud & Se har en offentlig Download PDF-knap i iPaper-læseren, men den eksponerer ikke en stabil PDF-adresse i arkivets HTML; den vises derfor foreløbig som læserbaseret frem for at efterligne klik i en browser. Når en kilde ikke tilbyder en direkte offentlig PDF, viser henteren blot dette og downloader intet. Du kan når som helst trykke **Scan og hent magasiner nu** for at få de nuværende offentlige filer uden at vente på natkørslen.
